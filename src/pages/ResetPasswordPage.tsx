    ...
    >
      ...
      <div
        style={{
          ...
          inset: 0,
          background:
            "radial-gradient(circle at 18% 18%, rgba(37,99,235,0.12), transparent 40%), " +
            "radial-gradient(circle at 82% 92%, rgba(37,99,235,0.12), transparent 45%), " +
            "var(--bg)",
          zIndex: 0,
        }}
      />
          ...
          >
            ...
            <button
              ...
              style={{
                ...
                border: "none",
                background:
                  "linear-gradient(180deg, var(--accent) 0%, var(--coral) 100%)",
                ...
                gap: 10,
                cursor:
                  resetPassword.isPending || !token ? "not-allowed" : "pointer",
