...
const LIVE_TICKS = [
  {
    chip: "GENERATING IDEAS",
    title: "5 hook-scored ideas",
    status: "Pulling trending topics in your niche…",
    progress: 28,
    tone: "coral" as const,
  },
  {
    chip: "DRAFTING SCRIPT",
    title: "Script v1 · 1,240 words",
    status: "Hook · Intro · 3 systems · CTA",
    progress: 62,
    tone: "coral" as const,
  },
  {
    chip: "QUALITY REVIEW",
    title: "Live review · 84 / 100",
    status: "Hook strong · CTA placement +",
    progress: 88,
    tone: "mint" as const,
  },
  {
    chip: "TITLE CTR",
    title: "+18% predicted CTR",
    status: '"3 Systems That Made Me Consistent"',
    progress: 96,
    tone: "coral" as const,
  },
  {
    ...
    status: "Bold-text · Cinematic · Minimal · Meme",
    progress: 74,
    tone: "plum" as const,
  },
];
...
export default function LiveStudioAuth({
  mode,
  onSubmit,
  onGoogle,
  submitting,
  ...
  useEffect(() => {
    const t = setInterval(
      () => setTick((i) => (i + 1) % LIVE_TICKS.length),
      2400,
    );
  ...
  const activeStep = Math.min(
    4,
    Math.floor((tick * PIPELINE.length) / LIVE_TICKS.length),
  );
        ...
        >
          <div
            style={{
              ...
              maskImage:
                "radial-gradient(circle at 50% 60%, black 0%, transparent 75%)",
              WebkitMaskImage:
                "radial-gradient(circle at 50% 60%, black 0%, transparent 75%)",
              pointerEvents: "none",
            }}
          ...
          >
            ...
            >
              From idea to{" "}
              <i style={{ color: "var(--accent)", fontStyle: "italic" }}>
                published
              </i>
              <br />
              in one workspace.
            ...
            >
              19 AI tools wired into a single pipeline. Stop tab-switching
              between 8 apps. Average creator publishes{" "}
              <b style={{ color: "var(--ink)", fontWeight: 700 }}>2× more</b> in
              their first month.
            </p>
          </div>
  ...
  return (
    ...
    >
      <svg width={26} height={26} viewBox="0 0 32 32" aria-hidden>
        ...
        <path d="M12 10.2l9 5.8-9 5.8z" fill="var(--accent)" />
      </svg>
      <div>
        <div
          style={{
              ...
              style={{
                ...
                background: done
                  ...
                  : cur
                    ? "var(--coral-soft)"
                    : "var(--bg-soft)",
                color: done ? "white" : cur ? "var(--coral)" : "var(--ink-4)",
                display: "flex",
                alignItems: "center",
  ...
  return (
    ...
    >
      ...
      >
        ...
        <p
          style={{ margin: "10px 0 28px", color: "var(--ink-3)", fontSize: 14 }}
        >
          {isSignup
  ...
  return (
    ...
    >
      <svg width={18} height={18} viewBox="0 0 18 18" aria-hidden>
        <path
          fill="#4285F4"
          d="M17.6 9.2c0-.6 0-1.2-.2-1.8H9v3.4h4.8c-.2 1.1-.8 2-1.8 2.6v2.2h2.9c1.7-1.6 2.7-4 2.7-6.4z"
        />
        <path
          fill="#34A853"
          d="M9 18c2.4 0 4.5-.8 6-2.2l-2.9-2.2c-.8.6-1.9.9-3.1.9-2.4 0-4.4-1.6-5.1-3.7H.9v2.3A9 9 0 0 0 9 18z"
        />
        <path
          fill="#FBBC05"
          d="M3.9 10.7a5.4 5.4 0 0 1 0-3.5V5H.9a9 9 0 0 0 0 8.1z"
        />
        <path
          fill="#EA4335"
